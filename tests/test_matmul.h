...
void test_matmul() {
    ...
    ffml_tensor * b_2d = ffml_tensor_create(2, {4,3,0,0}, "b_2d");

    ffml_tensor * matmul_2d = ffml_op(FFML_OP_MATMUL, a_2d, b_2d);
    ...
    test_equal(ffml_get_data(b_2d, {0,1,0,0}), 20.0f);
    test_equal(ffml_get_data(b_2d, {0,2,0,0}), 30.0f);
    test_equal(ffml_get_data(b_2d, {1,0,0,0}), 40.0f);
    test_equal(ffml_get_data(b_2d, {1,1,0,0}), 50.0f);
    test_equal(ffml_get_data(b_2d, {1,2,0,0}), 60.0f);
    test_equal(ffml_get_data(b_2d, {2,0,0,0}), 70.0f);
    test_equal(ffml_get_data(b_2d, {2,1,0,0}), 80.0f);
    test_equal(ffml_get_data(b_2d, {2,2,0,0}), 90.0f);
    test_equal(ffml_get_data(b_2d, {3,0,0,0}), 100.0f);
    test_equal(ffml_get_data(b_2d, {3,1,0,0}), 110.0f);
    test_equal(ffml_get_data(b_2d, {3,2,0,0}), 120.0f);
    ...
    test_almost_equal_grad(b_2d, {0,1,0,0}, 297.0f);
    test_almost_equal_grad(b_2d, {0,2,0,0}, 363.0f);

    test_almost_equal_grad(b_2d, {1,0,0,0}, 286.0f);
    test_almost_equal_grad(b_2d, {1,1,0,0}, 374.0f);
    test_almost_equal_grad(b_2d, {1,2,0,0}, 462.0f);

    test_almost_equal_grad(b_2d, {2,0,0,0}, 341.0f);
    test_almost_equal_grad(b_2d, {2,1,0,0}, 451.0f);
    test_almost_equal_grad(b_2d, {2,2,0,0}, 561.0f);

    test_almost_equal_grad(b_2d, {3,0,0,0}, 396.0f);
    test_almost_equal_grad(b_2d, {3,1,0,0}, 528.0f);
    test_almost_equal_grad(b_2d, {3,2,0,0}, 660.0f);
