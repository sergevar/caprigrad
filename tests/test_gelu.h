...
void test_gelu() {
    ...
    ffml_tensor * gelu = ffml_unary_op(FFML_OP_GELU, a, "gelu");
...
// b10	0.61051140881012
    ...
    test_almost_equal(ffml_get_data(gelu, {1,0,0,0}), 2.9960f);
    test_almost_equal(ffml_get_data(gelu, {2,0,0,0}), 0.8413f);
    test_almost_equal(ffml_get_data(gelu, {3,0,0,0}), 1.9545f);
    test_almost_equal(ffml_get_data(gelu, {4,0,0,0}), 2.9960f);
    ...
    test_almost_equal_grad(a, {1,0,0,0}, 1.0119f);
    test_almost_equal_grad(a, {2,0,0,0}, 1.0833f);
    test_almost_equal_grad(a, {3,0,0,0}, 1.0852f);
    test_almost_equal_grad(a, {4,0,0,0}, 1.0119f);
    test_almost_equal_grad(a, {5,0,0,0}, 1.0005f);
